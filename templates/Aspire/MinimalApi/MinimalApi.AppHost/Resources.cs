...
{
    public const string ContainerSuffixKey = "MinimalApi:ContainerSuffix";
    public const string SqlServer = "MinimalApi-sql";
    ...
    extension(IDistributedApplicationBuilder builder)
    {
        ...
        {
            return builder.AddAzureSqlServer("MinimalApi-sql");
        }
        ...
        public IResourceBuilder<SqlServerServerResource> AddSqlServer()
        {
            ...
            return builder
                ...
                .WithDataVolume("MinimalApi-database")
...
#pragma warning restore ASPIREINTERACTION001
    ...
    extension(IResourceBuilder<SqlServerServerResource> sql)
    {
        ...
        {
            var database = sql.AddDatabase("MinimalApi-db");
