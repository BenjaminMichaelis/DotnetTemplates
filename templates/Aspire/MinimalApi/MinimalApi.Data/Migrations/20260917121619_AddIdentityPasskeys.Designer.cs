...
namespace MinimalApi.Data.Migrations
{
    ...
    [Migration("20260917121619_AddIdentityPasskeys")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MinimalApi.Data.ApplicationUser", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("MinimalApi.Data.Question", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("MinimalApi.Data.Room", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("MinimalApi.Data.ApplicationUser", null)
                        .WithMany()
            ...
            modelBuilder.Entity("MinimalApi.Data.Question", b =>
                {
                    b.HasOne("MinimalApi.Data.Room", "Room")
                        .WithMany("Questions")
            ...
            modelBuilder.Entity("MinimalApi.Data.Room", b =>
                {
                    b.HasOne("MinimalApi.Data.ApplicationUser", "CreatedBy")
                        .WithMany()
                        .HasForeignKey("CreatedByUserId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("MinimalApi.Data.Question", "CurrentQuestion")
                        .WithMany()
